...
**33 queue events** · run `spec` · target `existing-leaf-engine` · schema `3.1.0`
...
`Krippendorff alpha`, `inter-rater reliability`, `evidence labelling`
...
- idempotency key `ded2af8870aaa21896d55d13551e1c251489761b4abc671f639af406399e5f80`
- queue event `q-ded2af8870aaa218`
...
`taxonomy`, `CoreSC anchors`, `coarse types`
...
- idempotency key `8ece40fab1e85fe6f7079775d7fa4a6ae4b2847cbe0c7224bc04b2e0f830a680`
- queue event `q-8ece40fab1e85fe6`
...
`per-category reliability`, `surface tests`, `CoreSC`
...
- idempotency key `3bcefdffb56ff48fb3f499f1d21028bb084132fabea5541a8cb72d1449ff2d2e`
- queue event `q-3bcefdffb56ff48f`
...
`residual labels`, `abstention`, `confidence thresholds`
...
- idempotency key `50c62b6ec74936117c2ec5f81265559342e5838bcc7ca62b6ecd7154f65a39a3`
- queue event `q-50c62b6ec7493611`
...
`epistemic status`, `residual entropy`, `two-field design`
...
- idempotency key `418af76f0dcd1683e8b91c6818067299009cc6254aca024771ca7800d94d580d`
- queue event `q-418af76f0dcd1683`
...
`confounding`, `item sets`, `collision testing`
...
- idempotency key `3338074a1640a62c1d9020c0a1d90aad6c037b0c2d36d0206c38d80d39cdb237`
- queue event `q-3338074a1640a62c`
...
`renames`, `collision testing`, `strip test`
...
- idempotency key `7e931d1adbc49906372dc88c43e0d6faa208e25b779fe83361e4a8fc3be66822`
- queue event `q-7e931d1adbc49906`
...
`codebook design`, `annotator training`, `surface tests`
...
- idempotency key `c6940ee17d500f9d2c5e901adc30b44e3f5135dffb996b79249f3bbac43d9b20`
- queue event `q-c6940ee17d500f9d`
...
`definition shape`, `cue`, `exclusions`
...
- idempotency key `8b84043c3d9ecb179a514973c9abcf8b96cf6967b7c6a26f3d929bb92551a36e`
- queue event `q-8b84043c3d9ecb17`
...
`label definitions`, `codebook`, `surface cues`
...
- idempotency key `4789bd26fdc8016c10700bba661753d07b84c4e915e2ce9839020efd60a1bbc8`
- queue event `q-4789bd26fdc8016c`
...
`pairwise separations`, `label collisions`, `codebook`
...
- `u-src-specification-bf9781a3-0094`
- `u-src-specification-bf9781a3-0095`
- `u-src-specification-bf9781a3-0087`

### Traceability

- idempotency key `660ecc68a244a83fc3283059a826f037f04252ac57fcd30bbd4934bd8348dd2b`
- queue event `q-660ecc68a244a83f`
...
`binary framing`, `priority resolution`, `prompt versioning`
...
- `u-src-specification-bf9781a3-0096`
- `u-src-specification-bf9781a3-0097`
- `u-src-specification-bf9781a3-0098`

### Traceability

- idempotency key `dbbbe4ad0e6c99cb0d3c859010e69013c115b09948d20e579392fbda57cc0235`
- queue event `q-dbbbe4ad0e6c99cb`
...
`conversational text`, `few-shot exemplars`, `evidence gaps`

### Source units (1)

- `u-src-specification-bf9781a3-0119`

### Traceability

- idempotency key `063db5cd899d457ec712ab4e2d323d66700088cf530a77cac929f3d6738101b0`
- queue event `q-063db5cd899d457e`
...
`gold set`, `ablation`, `kill criterion`, `temporal validity`

### Source units (4)

- `u-src-specification-bf9781a3-0124`
- `u-src-specification-bf9781a3-0125`
- `u-src-specification-bf9781a3-0126`
- `u-src-specification-bf9781a3-0127`

### Traceability

- idempotency key `977320d1f2545cd41b20550cbfef4de47bda7714b0e082c1608e2c62058bcbc6`
- queue event `q-977320d1f2545cd4`
...
`evidence register`, `design decisions`, `noise floor`
...
- `u-src-specification-bf9781a3-0129`
- `u-src-specification-bf9781a3-0130`
- `u-src-specification-bf9781a3-0131`
- `u-src-specification-bf9781a3-0132`

### Traceability

- idempotency key `b6c40375bc51b573ebc8329906f721714785964b8e49a4ee406860a7cc50ac31`
- queue event `q-b6c40375bc51b573`
...
`label removal`, `coverage gaps`, `permission statements`
...
- idempotency key `2f7c260ffcf13cf0092a9682001caf34aa114fe13046d75e9661768530458ffd`
- queue event `q-2f7c260ffcf13cf0`
...
- idempotency key `badc3c6223201ad6d867addf615dc42345d46890fd6c3cab54015f7240e72389`
- queue event `q-badc3c6223201ad6`
...
`classification API`, `append-only records`, `scope boundaries`
...
- idempotency key `e1127b970075b1abddb7293462a58cf4032aa7021d2c52ea1bbd3c865ad95ee4`
- queue event `q-e1127b970075b1ab`
...
- idempotency key `81488c4776a91af2871077ccd1ec3ada0cdc88b91a26fe0321f0c976aaa1bdc5`
- queue event `q-81488c4776a91af2`
...
- idempotency key `2c50066cfcc9a7cb2a52e3dd640352a96cef9a460e7a8608e20dbf7a604518a3`
- queue event `q-2c50066cfcc9a7cb`
...
- idempotency key `9a6e37e86558c1f13aefa2299a8903854d8feeaa8cd6b94f6e1f269ffcf55656`
- queue event `q-9a6e37e86558c1f1`
...
- idempotency key `7a58ea0956a6b1104a86547ca28d2a839852b5db54247984677c8a52b210cad4`
- queue event `q-7a58ea0956a6b110`
...
- idempotency key `3ea04516f16ca97b6c6ed74377f129af60ff7fb33bc53c68ae0c80747179499e`
- queue event `q-3ea04516f16ca97b`
...
- idempotency key `e1fbe44560a897a7d42421c83ebbd93cfa066cdf0ab2d008c8ba82b69be22cdf`
- queue event `q-e1fbe44560a897a7`
...
`generality test`, `principle`, `surface tests`
...
- idempotency key `cbe2b0c26b81e33efc32a18e7ca159fc026950ddbce950b8f2b3f8057a7f49c7`
- queue event `q-cbe2b0c26b81e33e`
- audits `audit-cand-025`
...
- idempotency key `467ee815511590e7c2dc74ee33148b0a4ab68541877ebc3c10c07a4e62d6e7e8`
- queue event `q-467ee815511590e7`
- audits `audit-cand-026`
...
- idempotency key `4d85a75f58bbc0a61fb2f147faa5f30a447e417b22397a15b4e18b8341e1139b`
- queue event `q-4d85a75f58bbc0a6`
- audits `audit-cand-027`
...
- idempotency key `7b788e60795ecfe8d8f96c31b7d26f91ee45c4d711af8c45005372301b109cee`
- queue event `q-7b788e60795ecfe8`
- audits `audit-cand-028`
...
- `u-src-specification-bf9781a3-0099`
- `u-src-specification-bf9781a3-0100`
- `u-src-specification-bf9781a3-0101`
- `u-src-specification-bf9781a3-0102`
- `u-src-specification-bf9781a3-0103`
- `u-src-specification-bf9781a3-0104`
- `u-src-specification-bf9781a3-0106`
- `u-src-specification-bf9781a3-0107`
- `u-src-specification-bf9781a3-0108`
- `u-src-specification-bf9781a3-0105`

### Traceability

- idempotency key `3c8aef83c4610aef68e851c7e472b8a46c4f9f103a2992ddc6c07a8414fac644`
- queue event `q-3c8aef83c4610aef`
- audits `audit-cand-029`
...
`form field`, `provenance`, `modality`, `flags`
...
- `u-src-specification-bf9781a3-0109`
- `u-src-specification-bf9781a3-0110`
- `u-src-specification-bf9781a3-0112`
- `u-src-specification-bf9781a3-0113`
- `u-src-specification-bf9781a3-0114`
- `u-src-specification-bf9781a3-0115`
- `u-src-specification-bf9781a3-0116`
- `u-src-specification-bf9781a3-0117`
- `u-src-specification-bf9781a3-0111`

### Traceability

- idempotency key `fb144dc5eeef0334c9acc2750cd17c5e8059b311fd8e540f9895ccfddaea0a60`
- queue event `q-fb144dc5eeef0334`
- audits `audit-cand-030`
...
- `u-src-specification-bf9781a3-0118`
- `u-src-specification-bf9781a3-0120`
- `u-src-specification-bf9781a3-0121`

### Traceability

- idempotency key `9c38c443ec6346e6bb5f89536a2e726502f7294a8bda7b17aad34e8df511892c`
- queue event `q-9c38c443ec6346e6`
- audits `audit-cand-031`
...
- `u-src-specification-bf9781a3-0122`
- `u-src-specification-bf9781a3-0128`
- `u-src-specification-bf9781a3-0123`

### Traceability

- idempotency key `4549149549abee56576fa206255eef084e754bb3c4b3ed890aac007e48b1d1a3`
- queue event `q-4549149549abee56`
- audits `audit-cand-032`
...
- `u-src-specification-bf9781a3-0133`
- `u-src-specification-bf9781a3-0134`
- `u-src-specification-bf9781a3-0135`
- `u-src-specification-bf9781a3-0136`

### Traceability

- idempotency key `48f8552e7c893d3752c61f1f11d6a0d57c32d1eb875f670534dc897866f724b8`
- queue event `q-48f8552e7c893d37`
- audits `audit-cand-033`
