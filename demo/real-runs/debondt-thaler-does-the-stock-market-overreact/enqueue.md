...
**23 queue events** · run `dt` · target `existing-leaf-engine` · schema `3.1.0`
...
- idempotency key `75827934f9ed52f387a100752c1a672642829a1788be999126186f355b0da28a`
- queue event `q-75827934f9ed52f3`
...
- idempotency key `a0c5d2ebfd5067a1f4784f420132c93ffc67e71aa2ddff6f9fd0eb4c11e95578`
- queue event `q-a0c5d2ebfd5067a1`
...
- idempotency key `4bfa07f5f31f0c511fdb3b0aa5a78f1030e9fe30c9df646f7e1839c0c41cd4e2`
- queue event `q-4bfa07f5f31f0c51`
...
- idempotency key `fd0963043badce48ce6de9f1a28d00874d0f87a920221397565d791edb3ed3e9`
- queue event `q-fd0963043badce48`
...
- idempotency key `f4cfa0cace6e44393f0d10f60fc46de27d8287a0a34ba1627e5307f7c58828ad`
- queue event `q-f4cfa0cace6e4439`
...
- idempotency key `a2aaa6ffee8a70026343b6fffa7f06d9d50fba94a64e320378329e3a2e19812e`
- queue event `q-a2aaa6ffee8a7002`
...
- idempotency key `4fdadf07cc1ccc31a0cacb00334cea29b2cc7a8314348766cdee22c5f104a8e3`
- queue event `q-4fdadf07cc1ccc31`
...
- idempotency key `047658b3f442dd4f074159821b638efbf6c833cea42ec0aa53d804dada60694f`
- queue event `q-047658b3f442dd4f`
...
- idempotency key `fa33f6dadc3e74c9b743b2b3f315ae83b5f8da77b9205f9cd5b4d16b82e9c178`
- queue event `q-fa33f6dadc3e74c9`
...
- idempotency key `4155e1a613f510da283310dec7824e62eb8577215d7583dfa227fa138f690433`
- queue event `q-4155e1a613f510da`
...
- idempotency key `7ee3627d27c9a53d26ed3af10a514b9e15e2c9856825e6e93c53dc48e47b80c6`
- queue event `q-7ee3627d27c9a53d`
...
- idempotency key `6487e70eae027dc43145804d08dc38c36d267edf059f711cdd50948915d8178f`
- queue event `q-6487e70eae027dc4`
...
- idempotency key `c733139d7183e4e1e1e61ca96a3031a9eb58e6f9a3cd4f1654c2c13ba41aef29`
- queue event `q-c733139d7183e4e1`
...
- idempotency key `afa4530e4f92464358f2ce95eaed848b7d8a5c66da94524bb75e01638d1df921`
- queue event `q-afa4530e4f924643`
...
- idempotency key `82bbd7ab423bbc652ed7109d902e87adf6cb831e2711d22c08e8f3c01e62a54c`
- queue event `q-82bbd7ab423bbc65`
...
- idempotency key `da49cbe3e2b17370797a68298b4fdbba20a249a1f18260238111246110c6919c`
- queue event `q-da49cbe3e2b17370`
...
- idempotency key `927454563e73f31950bb216e662ead44e7e5dfcd8ea9400f6a1594bfd6a43de1`
- queue event `q-927454563e73f319`
...
- idempotency key `ef24f9daec32c37fe0d05dabbee96a9578ad62821e917036cedfc132fd051d09`
- queue event `q-ef24f9daec32c37f`
...
- idempotency key `96a53c3dfea981c91bf7ba112134c37c6489a3a04ecb17373d2c1adfa086d37c`
- queue event `q-96a53c3dfea981c9`
...
- idempotency key `bf7e4c85ea9922594f2e43d108d77fd824ebf5372733374518cc565d15a45040`
- queue event `q-bf7e4c85ea992259`
...
`What the overreaction hypothesis predicts`
...
- `u-src-debondt-thaler-1985-overreact-d07fdf64-0059`
- `u-src-debondt-thaler-1985-overreact-d07fdf64-0060`
- `u-src-debondt-thaler-1985-overreact-d07fdf64-0063`

### Traceability

- idempotency key `e7808a699afe12a8964a7f0b9be662672946832ec826e46dc1e54e2510a4817e`
- queue event `q-e7808a699afe12a8`
...
`The replication recipe: CRSP, formation windows, ranking, rebalancing`
...
- `u-src-debondt-thaler-1985-overreact-d07fdf64-0061`
- `u-src-debondt-thaler-1985-overreact-d07fdf64-0062`
- `u-src-debondt-thaler-1985-overreact-d07fdf64-0064`

### Traceability

- idempotency key `82d51f332b6fcefeaafce936cb3838e14a2084de8751493560eb6bf0f18e17e7`
- queue event `q-82d51f332b6fcefe`
...
`The test statistics, recovered from the page rather than the text layer`
...
- `u-src-debondt-thaler-1985-overreact-d07fdf64-0065`
- `u-src-debondt-thaler-1985-overreact-d07fdf64-0066`
- `u-src-debondt-thaler-1985-overreact-d07fdf64-0067`
- `u-src-debondt-thaler-1985-overreact-d07fdf64-0068`

### Traceability

- idempotency key `97ad25bfab9ef853200187489b16b6d290714039a21afb4d65e94211671e11ae`
- queue event `q-97ad25bfab9ef853`
